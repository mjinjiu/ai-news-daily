...
const Renderer = (function () {
  ...
  function renderNotesSection(data) {
    ...
    if (totalCount === 0) {
      container.innerHTML = '<div class="frontline-placeholder"><div class="placeholder-icon">✨</div><h3>前线笔记空空如也</h3><p>有想法、观察到现象、或值得记录的技术思考，随时丢给我，帮你写成前线笔记。</p></div>';
